...
function showOnboarding(){
  ...
  overlay.style.cssText='position:fixed;inset:0;background:rgba(0,0,0,.15);display:flex;align-items:center;justify-content:center;z-index:500;padding:20px 64px;backdrop-filter:blur(0.5px);-webkit-backdrop-filter:blur(0.5px)';
...
function renderDash(){
  ...
  // flameSvg() lives in flames.js — edit there to change flame visuals.
